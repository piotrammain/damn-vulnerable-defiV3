...
The totalAssets function is overridden to always return the balance of the vault contract ```solidity(asset.balanceOf(address(this)))```. This introduces a separate accounting system based on tracking the supply of vault tokens.
